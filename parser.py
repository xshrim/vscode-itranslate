...
for item in parsed_dict:
  if item['simplified'] == "𱅒":
    continue
  dictionary[item['traditional']] = {"pinyin": item['pinyin'], "english": item['english']}
  dictionary[item['simplified']] = {"pinyin": item['pinyin'], "english": item['english']}
